(()=>{var e={};e.id=837,e.ids=[837],e.modules={629:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>g,routeModule:()=>c,serverHooks:()=>x,workAsyncStorage:()=>l,workUnitAsyncStorage:()=>d});var n={};r.r(n),r.d(n,{POST:()=>u});var a=r(6559),s=r(8088),o=r(7719),i=r(2190),p=r(7449);async function u(e){try{let{existingTopics:t}=await e.json(),r=process.env.GOOGLE_GENERATIVE_AI_API_KEY;if(!r)return i.NextResponse.json({error:"API Keyが設定されていません"},{status:500});let n=process.env.GENERATIVE_MODEL||"models/gemini-2.5-flash",a=new p.ij(r).getGenerativeModel({model:n}),s=`
